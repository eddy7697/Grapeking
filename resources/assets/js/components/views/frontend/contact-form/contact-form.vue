        ...
        <div class="col-md-12 contact-form-body">
            <div class="row">
                <div class="col-3 column important" require-label="*">
                    <p>{{i18n.contact1}}&nbsp;<span style="color: red">*</span></p>
                </div>
            ...
            <div class="row">
                <div class="col-3 column important" require-label="*">
                    <p>{{i18n.contact2}}&nbsp;<span style="color: red">*</span></p>
                </div>
                <div class="col-9 column">
            ...
            <div class="row">
                <div class="col-3 column important" require-label="*">
                    <p>{{i18n.email}}&nbsp;<span style="color: red">*</span></p>
                </div>
                <div class="col-9 column">
            ...
            <div class="row">
                <div class="col-3 column important" require-label="*">
                    <p>{{i18n.phone}}&nbsp;<span style="color: red">*</span></p>
                </div>
                <div class="col-9 column">
            ...
            <div class="row">
                <div class="col-3 column important" require-label="*">
                    <p>{{i18n.company_title}}&nbsp;<span style="color: red">*</span></p>
                </div>
                <div class="col-9 column">
            ...
            <div class="row">
                <div class="col-3 column important" require-label="*">
                    <p>{{i18n.follow_prod}}&nbsp;<span style="color: red">*</span></p>
                </div>
                <div class="col-9 column">
                    <div class="form-check-inline">
                        <label class="form-check-label">
