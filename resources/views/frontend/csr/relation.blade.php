...
<style>
.sub-page-banner {
    background-image: url('https://grapeking.shuo-guo.net/img/csr/csr-1.jpg');
}
</style>
@if (App::getLocale() == 'en')
<style>
                ...
                <div class="about-text">
                    <div class="row">
                        ...
                        <div class="col-md-5 mobile-to-left">
                            <img class="about-image" style="margin: 0; width: 100%; max-width: 400px; display: inline-block" src="https://grapeking.shuo-guo.net/img/csr/relation-1.jpg" alt="">
                        </div>
                    </div>                    
                </div>
                ...
                <div class="about-text">
                    <div class="row">
                        <div class="col-md-6" style="text-align: left">
                            <img class="about-image" style="margin: 0; width: 100%; max-width: 400px; display: inline-block" src="https://grapeking.shuo-guo.net/img/csr/relation-2.jpg" alt="">
