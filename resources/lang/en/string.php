...
return [
    ...
    'index_d_3' => 'Established in',
    'index_d_4' => 'Employees',
    'index_d_5' => 'Awards and Honors',
    'index_d_6' => 'SFDA Approval',
    'index_d_7' => 'Our professional development',
    'index_d_8' => "Biology Center was established in 1991 in Taoyuan, Taiwan. It has both innovative material development and production functions. The R&D is mainly for the development and application of its own materials (key components), so it is actively cooperating with academics and research institutions. , research and development of materials, functional verification and process improvement to establish the company's core technology. In addition, there are about nine applications for the biotechnology related departments of the Technical Department and the Industrial Bureau of the Ministry of Economic Affairs. There are about 20 production and learning programs of the National Science Council, the Agriculture Committee and the Ministry of Education. Currently, there are one in the United States and six in China. And thirty-five patents in Taiwan on the Zhizhi, Xiangshanzhi, lactic acid bacteria, antibiotics, Hericium erinaceus, Lilac mushroom, and silk flowers. ",
    'index_d_9' => "The Longtan Biotechnology Research Institute was newly established at the end of 2018. Combining the research and development experience of the original biological center for nearly 30 years, it has both innovative material development and production functions. The research and development aspect is mainly self-owned material (key components). Development and application, actively cooperate with domestic academic circles and research institutions to carry out material research and development, functional verification and process improvement to establish the company's core technology. In addition, it has applied for and implemented nine programs of biotechnology related departments of the Technical Department and the Industrial Bureau of the Ministry of Economic Affairs. The National Science and Technology Commission and the Ministry of Education have about 40 production and learning programs, and currently have the United States, China, and Japan.丶 Canada and Taiwan have 55 patents on 樟 丶 丶 丶 丶 丶 丶 丶 丶 丶 丶 丶 丶 丶 。 。 。 。 。 。 。 。 。 。 。 。 。 。 。 ",
    'index_d_10' => "The grape king is equipped with the international standard 'ISO / IEC 17025 TAF certification laboratory' to provide the most stringent checks for the company's products. At present, the self-inspection includes: general physical property, chemical and food safety related test items. The test method is not only required by TAF (National Certification Foundation of the Foundation), but also with reference to the Ministry of Health and Welfare of the Taiwan Executive Yuan and the Bureau of Standards and Inspection of the Ministry of Economic Affairs. A method of determination or an internationally recognized test method (such as AOAC). ",
    'index_d_11' => '<p>Shanghai Grape King Enterprises Corp. is located in Shanghai Song-Jiang Industrial Park which is 30 kilometers from the city, conveniently connected via the Han-Hu Freeway and Jia-Jin Freeway. This prime location enables us to provide more convenient services to the clients around China and the world.</p>',
    'index_d_12' => '<p>In addition to the brilliant achievements of OEM and ODM in production and manufacturing, Shanghai Grape King has also made remarkable achievements. In terms of professional research and development, it has set up food safety center, Grape King Biotech Research Institute and Innovation Research Center to provide professional research and development.</p>',
    ...
    'career_d_2' => 'Grape King sincerely welcomes you to join',
    'career_d_3' => '80 points of professional 100 points attitude = Grape King talent program',
    ...
    'career_d_10' => 'Please submit your resume through the <a href="#">Zhilian recruitment website</a>. After the qualification is approved, you will be notified of the interview. ',
    ...
    'career_d_14' => 'Please submit your resume via the <a href="#">Zhilian recruitment website</a>. After the qualification is approved, you will be notified of the interview. ',
