...
return [
    ...
    'about_4' => 'Location',
    'about1' => 'In 2019, Grape King Bio opened the “Grape King Biotech Research Institute” which is located at LongTan Science Park. The new Institute incorporates the existing Bioengineering Center (established in 1991) and is now the main R&D and fermentation cultivation control center for the Grape King group. We now have 386 tons of physical fermentation tanks split between Zhongli and Longtan sites, the largest capacity for healthfood in Taiwan. This capacity is made up of six 1 ton, a 2 ton, a 3 ton, five 5 ton, a 10 ton, two 15ton, four 20 ton, four 40 ton and a 50 ton. Downstream manufacturing facilities include membrane concentration systems, freeze-dryers, centrifuges, cold fluid bed dryers and pressure filters which work together with the fermenters to cultivate raw materials for Grape King Bio, Pro-Partner Ltd. and Shanghai Grape King products.',
    'about2' => 'Grape King Bio',
    'about3' => 'location',
    'about4' => 'Contact Us',
    'about5' => 'Shanghai Grape King Enterprise Co., Ltd.',
    'about6' => '"Shanghai Grape King Enterprises Corp." is a subsidiary wholly owned by Grape King Bio; established in Songjiang District of Shanghai in 1994 and officially launched in 1997. We have successfully transplanted the biotechnology research technology and high-quality production technology of Grape King Bio Group and provide One-Stop service about the ODM/OEM Service、Bio-Professional R&D、Formulation Design、Packaging Design、Manufacturing Services and Logistic. Through One-Stop service, high-quality service, we can produce and develop differentiated products according to the needs of customers, so as to make customers With market advantages and competitiveness, Shanghai Grape King has become a reliable partner of many international companies. In the future, Grape King Bio Group and Shanghai Grape King will continually practice core value of "Technology, Health, and Hope", Using the latest technology available, we develop products to help consumers have healthier lives, ultimately giving hope for prosperous futures.​',
    ...
    'index_d_8' => "In 2019, Grape King Bio opened the “Grape King Biotech Research Institute” which is located at LongTan Science Park.  It has inherited the nearly 30 years' R&D experiences from the original Bioengineering Center and possesses both innovative material development and production functions. In terms of R&D, the institute mainly focus on the development and application of its own materials (key materials). At present, the institute owns 63 patents in the U.S., China, Japan, Canada and Taiwan, on Antrodia cinnamomea, A. salmonea, lactic acid bacteria, antibiotics, Hericium erinaceus, Wood Blewit, Vegetable cicada, etc. As for production, the original Bioengineering Center had large fermentation tanks (six 1-ton, one 2-ton, one 3-ton, five 5-ton, one 10-ton, four 20-ton, four 40-ton, one 50-ton), in addition to fifty 100-liter small fermentation tanks. the total fermentation capacity will reach 386 tons---ranking first among the health food industry in Taiwan.​",
